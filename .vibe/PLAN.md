...
- Context: `DESIGN.md` is the behavior contract and `README.md` is the intended operator experience; Stage 1 established the tested canonical load-to-compile core.
- Constraints:
